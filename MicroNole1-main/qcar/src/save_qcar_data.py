...
class QcarNode(object):
    ...
    def __init__(self):
        ...
        self.data_save_path = package_path / "data/Stationary_1_minute.csv"
    ...
    def looping(self):
        ...
        while not rospy.is_shutdown():            
            ...
            data = np.array([[self.dt, self.command[0], self.command[1], ax, ay, az, roll_rate, pitch_rate, yaw_rate,
                              current, batteryVoltage, encoderCounts]])
    ...
    def process_cmd(self, sub_cmd):
        ...
        str_cmd = sub_cmd.vector.y - 0.01 + 0.035  # why is the -0.01 term there? Feedforward?
